...
<section class="content lg:blur-0 py-10">
    ...
    <section class="container flex justify-between items-center lg:flex-row flex-col relative min-h-96 ">
        <form action="{{ route('auth.customer.mobile') }}" method="post" class="lg:w-5/12 w-full">
            @csrf
            ...
            <main class="flex items-center justify-center  w-full">
                ...
                <div class="flex flex-col w-full h-auto gap-10   lg:rounded-3xl bg-white  shadow-lg rounded-2xl dark:bg-dark dark:shadow-none p-5">
                    ...
                    <h2 class="text-4xl font-bold text-main">ورود / ثبت نام</h2>
                    @error('error')
                    <div>
                    ...
                    <div class="flex flex-col w-full gap-4">
                      ...
                      @enderror" placeholder=" شماره موبایل" type="text" />
                            ...
                            @enderror
                            @if (cache('settings')['method_login_register'] == 0 ||
                            cache('settings')['method_login_register'] == 1)

                            <span class="font-bold text-gray-400">ورود با<a
                                    href="{{ route('auth.customer.loginForm') }}" class="text-main"> ایمیل </a></span>
                            @endif
                        <button type="submit"
