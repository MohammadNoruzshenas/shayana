...
@section('content')
    ...
    <div class="row no-gutters bg-white">
        <div class="col-12">
            <form action="{{ route('admin.notify.notification.store') }}" method="post" enctype="multipart/form-data"
                class="padding-30">
                @csrf
                ...
                <textarea name="description" placeholder="متن" required class="text h">{{ old('description') }}</textarea>
                @error('description')
                    <span class="text-error" role="alert">
                        <strong>
                            {{ $message }}
