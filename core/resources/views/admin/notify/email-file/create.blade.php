...
@section('breadcrumb')
    ...
    <li><a href="{{ route('admin.notify.email-file.index',$email) }}">افزودن فایل</a></li>
...
<div class="row no-gutters bg-white">
    <div class="col-12">
        <form action="{{ route('admin.notify.email-file.store',$email) }}" method="post" enctype="multipart/form-data" class="padding-30">
            @csrf
