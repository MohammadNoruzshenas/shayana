...
@section('breadcrumb')
    ...
    <li><a href="{{ route('admin.market.discount.commonDiscount.create') }}">ایجاد تخفیف عمومی</a></li>
@endsection
@section('content')
        ...
        <div class="main-content">
                ...
                <section class="row">
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="{{ old('title') }}"class="text w-10">
                        </div>
                        @error('title')
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="percentage" value="{{ old('percentage') }}" class="text w-10">
                        </div>
                        @error('percentage')
                            <span class="alert_required text-error p-1 rounded" role="alert">
                                <strong>
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control form-control-sm">
                                <option value="0" @if (old('type') == 0) selected @endif>همه دوره ها
                                </option>
                                <option value="1" @if (old('type') == 1) selected @endif>دوره ی خاص</option>
                                <option value="2" @if (old('type') == 2) selected @endif>همه اشتراک ها
                                </option>
                                <option value="3" @if (old('type') == 3) selected @endif>اشتراک خاص</option>
                                <option value="4" @if (old('type') == 4) selected @endif>همه اقلام سایت</option>
                                ...
                                <select name="course_id" id="course_id" class="form-control form-control-sm">
                                    @foreach ($courses as $course)
                                        <option value="{{ $course->id }}"
                                            @if (old('course_id') == $course->id) selected @endif>{{ $course->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('course_id')
            ...
            <section class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="discount_ceiling" value="{{ old('discount_ceiling') }}" class="text w-10">
                </div>
            ...
            <section class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="minimal_order_amount" value="{{ old('minimal_order_amount') }}" class="text w-10">
                </div>
