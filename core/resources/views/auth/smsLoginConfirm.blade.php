...
@section('head-tag')
    <title>تایید کد پیامک - {{ cache('templateSetting')['title'] }}</title>
    <style>
        .d-none {
            display: none;
        }
...
@section('content')
    ...
    <section class="content lg:blur-0 py-10">
        ...
        <section class="container flex justify-between items-center lg:flex-row flex-col relative min-h-96 ">
            <form action="{{ route('auth.customer.smsLoginConfirm', $token) }}" method="post" class="lg:w-5/12 w-full">
                @csrf
                ...
                <main class="flex items-center justify-center  w-full">
                    ...
                    <div
                        ...
                        <h2 class="text-4xl font-bold text-main">تایید کد پیامک</h2>
                      ...
                      <section id="timer" class="text-teal-500"></section>
                        <section id="resend-otp" class="d-none">
                            <a href="{{ route('auth.customer.smsLoginResendOtp', $token) }}" class="text-main">دریافت
                                مجدد کد تایید</a>
                        </section>
                        ...
                        <div class="flex flex-col gap-2">
                            <span class="font-bold text-gray-400">بازگشت به 
                                <a href="{{ route('auth.customer.smsLoginForm') }}" class="text-main"> ورود با پیامک </a>
                            </span>
                        ...
                        <button class="w-full text-white focus:border-main bg-main rounded-xl h-14 hover:bg-main/90">ورود
                        </button>
                </main>
            </form>
