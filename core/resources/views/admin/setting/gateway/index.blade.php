...
@section('breadcrumb')
    <li><a href="" title="درگاه">تنظیمات درگاه پرداخت</a></li>
@endsection
@section('content')
            ...
            <tbody>
                ...
                @foreach ($gateways as $gateway)
                    <tr role="row">
                        ...
                        <td>{{ $gateway->name_en ?? '-' }}</td>
                        <td @if($gateway->status == 1) style="color:green" @endif>{{ $gateway->status == 1 ? $gateway->name_fa . ' (فعال) ' : $gateway->name_fa}}</td>

                        <td>
                            @if ($gateway->status == 1)
                                <a href="{{ route('admin.setting.gateway.active', $gateway) }}" class="item-eye mlg-15"
                                    title="غیرفعال">
                            ...
                            <a href="{{ route('admin.setting.gateway.edit', $gateway) }}" class="item-edit " title="ویرایش">
