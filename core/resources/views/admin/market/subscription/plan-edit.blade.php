...
@section('content')
    <div class="col-12 bg-white">
        ...
        <div class="main-content">
            <form action="{{ route('admin.market.subscription.plans.update',$plan) }}" method="POST">
                @csrf
                @method('put')
                <section class="row">
                    ...
                    <section class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name',$plan->name) }}"class="text w-10">
                        </div>
                        @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description" value="{{ old('description',$plan->description) }}"class="text w-10">
                        </div>
                        @error('description')
                            <span class="alert_required text-error p-1 rounded" role="alert">
                                <strong>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="price" value="{{ old('price',numberFormat($plan->price)) }}"class="text w-10">
                        </div>
                        @error('price')
                            <span class="alert_required text-error p-1 rounded" role="alert">
                                <strong>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="subscription_day" value="{{ old('subscription_day',$plan->subscription_day) }}"class="text w-10">
                        </div>
                    ...
                    <section class="col-12">
                        <div class="form-group">
                            ...
                            <select name="status" id="" class="text w-10" id="status">
                                <option value="0" @if (old('status',$plan->status) == 0) selected @endif>غیرفعال</option>
                                <option value="1" @if (old('status',$plan->status) == 1) selected @endif>فعال</option>
                            </select>
                        </div>
                        @error('status')
                            <span class="alert_required  text-error p-1 rounded" role="alert">
