...
return [
    ...
    'attributes' => [
        ...
        'subject' => 'عنوان',
        'priority' => 'الویت',
        'limit_body' => 'تعداد کارکتر نمایش',
        'teacher_id' => 'مدرس',
        'progress' => 'درصد پیشرفت دوره',
        'description_site_index' => 'توضیحات',
        'show_resources_server' => 'نمایش منابع سرور',
        'priority' => 'الویت',
        'maximum_registration' => 'حداکثر ثبت نامی',
        'link' => 'لینک',
        'user' => 'کاربر',
        ...
        'percent' => 'درصد',
        'shaba' => 'شبا',
        'week_start_date' => 'تاریخ شروع هفته',
    ],
];
