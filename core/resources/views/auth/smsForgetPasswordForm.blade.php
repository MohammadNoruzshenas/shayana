...
@section('head-tag')
<title>بازیابی رمز عبور با پیامک - {{cache('templateSetting')['title']}}</title>
...
<section class="content lg:blur-0 py-10">
    ...
    <section class="container flex justify-between items-center lg:flex-row flex-col relative min-h-96 ">
        <form action="{{ route('auth.customer.smsForgetPassword') }}" method="post" class="lg:w-5/12 w-full">
            @csrf
            ...
            <main class="flex items-center justify-center  w-full">
                ...
                <div class="flex flex-col w-full h-auto gap-10   lg:rounded-3xl bg-white  shadow-lg rounded-2xl dark:bg-dark dark:shadow-none p-5">
                    ...
                    <h2 class="text-4xl font-bold text-main">بازیابی رمز عبور با پیامک</h2>
                    <p class="text-gray-600">شماره موبایل خود را وارد کنید تا کد تایید برای بازیابی رمز عبور ارسال شود</p>
