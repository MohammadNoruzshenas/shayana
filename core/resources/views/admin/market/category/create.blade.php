<div class="col-4 bg-white">
    ...
    <form action="{{ route('admin.market.category.store') }}" method="post" class="padding-30">
        @csrf
    ...
    <textarea name="svg_code" id="svg_code" placeholder="Svg Code"  class="text h ltr-text">{{ old('svg_code') }}</textarea>
    @error('svg_code')
        <span class="text-error" role="alert">
            <strong>
                {{ $message }}
